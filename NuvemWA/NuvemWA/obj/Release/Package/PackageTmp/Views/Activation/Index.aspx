...
<head runat="server">
    ...
    <link rel="SHORTCUT ICON" href="<%=ResolveUrl("../../../site/app/images/logo_icono.ico") %>" type="image/x-icon" />
    <style>
        a {
            font-size: 14px;
            text-align: center;
        ...
        <div class="well container">
            ...
            <div class="row">
                ...
                <div class="well-white">
                    ...
                    <div class="row">
                        <p>
                            Para aproveitar ao máximo e experimentar todos os recursos disponíveis do sistema Nuvem B2B, inicie o preenchimento de todos os dados da sua Empresa
                            <a href="<%=ResolveUrl("../../../site/Default.aspx") %>" class="btn btn-success center-block">clicando aqui.</a>
                        </p>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <p style="text-align: center">
                            Não se esqueça de que nossa equipe de suporte está disponível para ajudá-lo. Nosso canal de atendimento é 
                            <a href="mailto:suporte@nuvemb2b.com.br" class="btn btn-success center-block" target="_blank">suporte@nuvemb2b.com.br</a>
                        </p>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="row">
                <div class="row" style="margin: 2% 22% 0px 22%;">
                    <p class="text-center">
                        <small>Este e-mail é destinado apenas para envio de mensagens. Dessa forma, caso queira nos contatar, não responda para este e-mail - nós não receberemos sua mensagem. Utilize nosso suporte pelo e-mail: 
                            <a href="mailto:suporte@nuvemb2b.com.br" class="btn btn-primary center-block">suporte@nuvemb2b.com.br</a>
