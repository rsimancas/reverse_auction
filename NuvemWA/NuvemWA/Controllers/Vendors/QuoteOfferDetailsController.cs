...
namespace NuvemWA.Controllers
{
    ...
    [TokenValidation]
    public class QuoteOfferDetailsController : ApiController
    {
        static readonly IQuoteOfferDetailsRepository repository = new QuoteOfferDetailsRepository();
        ...
        public object Post(QuoteOfferDetail model)
        {
            object json;
