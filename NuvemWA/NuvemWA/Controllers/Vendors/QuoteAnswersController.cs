...
namespace NuvemWA.Controllers
{
    ...
    [TokenValidation]
    public class QuoteAnswersController : ApiController
    {
        static readonly IQuoteAnswersRepository repository = new QuoteAnswersRepository();
        ...
        public object Post(QuoteAnswer model)
        {
            object json;

            try
            {
                QuoteAnswer posted = repository.Add(model);
