namespace NuvemWA.Controllers
{
    ...
    [TokenValidation]
    public class VendorCategoriesController : ApiController
    {
        static readonly IVendorCategoriesRepository repository = new VendorCategoriesRepository();
        ...
        public object Post(VendorCategory model)
        {
            object json;
        ...
        public object Put(VendorCategory model)
        {
            object json;
        ...
        public object Delete(VendorCategory model)
        {
            object json;
