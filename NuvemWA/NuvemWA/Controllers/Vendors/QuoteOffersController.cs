...
namespace NuvemWA.Controllers
{
    ...
    [TokenValidation]
    public class QuoteOffersController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            try
            {
                ...
                {
                    QuoteOffer model = repository.Get(id);
        ...
        public object Post(QuoteOffer model)
        {
            object json;

            try
            {
                QuoteOffer posted = repository.Add(model);
        ...
        public object Put(QuoteOffer model)
        {
            object json;
        ...
        public object Delete(QuoteOffer model)
        {
            object json;
