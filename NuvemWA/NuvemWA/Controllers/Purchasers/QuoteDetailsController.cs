...
namespace NuvemWA.Controllers
{
    ...
    {
        static readonly IQuoteDetailsRepository repository = new QuoteDetailsRepository();
        ...
        public object Post(QuoteDetail model)
        {
            object json;
        ...
        public object Put(QuoteDetail model)
        {
            object json;
        ...
        public object Delete(QuoteDetail model)
        {
            object json;
