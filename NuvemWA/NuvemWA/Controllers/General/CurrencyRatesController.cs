...
namespace NuvemWA.Controllers
{
    ...
    public class CurrencyRatesController : ApiController
    {
        ...
        public object Post(CurrencyRate added)
        {
            object json;
            string messageError = "";
            ...
            try
            {
                CurrencyRate posted = repository.Add(added, ref messageError);
        ...
        public object Put(CurrencyRate updated)
        {
            object json;
            ...
            {
                string messageError = "";
                CurrencyRate putting = repository.Update(updated, ref messageError);
        ...
        public object Delete(CurrencyRate deleted)
        {
            string msgError = "";
