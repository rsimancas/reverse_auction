...
namespace NuvemWA.Controllers
{
    ...
    {
        static readonly ICurrenciesRepository repository = new CurrenciesRepository();
        ...
        public object Post(Currency added)
        {
            object json;
            string messageError = "";
            ...
            try
            {
                Currency posted = repository.Add(added, ref messageError);
        ...
        public object Put(Currency updated)
        {
            object json;
            ...
            {
                string messageError = "";
                Currency putting = repository.Update(updated, ref messageError);
        ...
        public object Delete(Currency deleted)
        {
            string msgError = "";
