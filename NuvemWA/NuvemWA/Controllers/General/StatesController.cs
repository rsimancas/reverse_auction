...
namespace NuvemWA.Controllers
{
    ...
    {
        static readonly IStatesRepository repository = new StatesRepository();
        ...
        public object GetAll()
        {
            ...
            try
            {
                ...
                {
                    State estatus = repository.Get(id);
        ...
        public object Post(State added)
        {
            object json;

            try
            {
                State posted = repository.Add(added);
        ...
        public object Put(State updated)
        {
            object json;

            try
            {
                State putting = repository.Update(updated);
        ...
        public object Delete(State deleted)
        {
            object json;
