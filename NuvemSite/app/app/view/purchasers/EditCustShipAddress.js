Ext.define('Nuvem.view.purchasers.EditCustShipAddress', {
    extend: 'Ext.form.Panel',
    alias: 'widget.EditCustShipAddress',
    modal: true,
    width: 500,
    layout: {
        type: 'absolute'
    ...
    onShowWindow: function() {
        this.down("field[name=CustShipAddress]").focus(true, 200);
    },
        ...
        record.save({
            callback: function(records, operation, success) {
                if (success) {
                    ...
                    var storeAddress = new Nuvem.store.CustShipAddress().load({
                        params: {
                            fieldFilters: fieldFilters,
                            page: 0,
                            start: 0,
