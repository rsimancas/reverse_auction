Ext.define('Nuvem.view.purchasers.EditQuoteHeaderService', {
    extend: 'Ext.form.Panel',
    alias: 'widget.purchasers.EditQuoteHeaderService',
    // modal: true,
    // width: screen.width * 0.5,
    // height: 580,
    layout: 'column',
    title: 'Nova Cotaçao - Serviço',
    // closable: true,
    // floating: true,
    autoScroll: true,
    callerForm: null,
            ...
            listeners: {
                beforeedit: {
                    ...
                    fn: function(rowEditing, context, eOpts) {
                        ...
                        var fieldFilters = JSON.stringify({
                            fields: [
                                { name: 'ItemType', value: 1, type: 'int' }
                            ]
                        });
    ...
    onBackToQuotes: function() {
        ...
        if (that.isNewRecord) {
            that.removeCurrentRecord(goToQuotes);
        } else {
            goToQuotes();
        }*/
    },

    removeCurrentRecord: function(callback) {
        var me = this,
