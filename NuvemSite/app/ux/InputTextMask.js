...
Ext.define('Ext.ux.InputTextMask', {
    ...
    injectValue: function(keycode, cursorPosition) {
        ...
        if (key) {
            this.inputTextElement.value = cursorPosition.previousValue.substring(0, cursorPosition.start) + key +
    ...
    CursorPosition: function(start, end, range, previousValue) {
        ...
        cursorPosition.inc = function() { cursorPosition.start++;
            cursorPosition.end++; };
        cursorPosition.dec = function() { cursorPosition.start--;
            cursorPosition.end--; };
