Ext.define('Overrides.grid.column.Action', {
  ...
  iconTpl: '<tpl for=".">' +
          '<tpl if="glyph">' +
          '<div class="{cls} x-override-action" style="color:#003C7E;font-family:{glyphFamily};  font-size:15px; line-height: 15px;"<tpl if="tooltip"> data-qtip="{tooltip}"</tpl>>&#{glyph};</div>' +
          '<tpl else>' +
